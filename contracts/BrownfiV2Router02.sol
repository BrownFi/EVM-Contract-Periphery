...
import './interfaces/IBrownfiV2Router02.sol';
...
contract BrownfiV2Router02 is IBrownfiV2Router02 {
    ...
    function _swapSupportingFeeOnTransferTokens(address[] memory path, address _to) internal virtual {
        for (uint i; i < path.length - 1; i++) {
            ...
            amountOutput = BrownfiV2Library.getAmountOut(amountInput, reserveInput, reserveOutput, pair.k());
            }
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut, uint k)
        public
        pure
        virtual
        override
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut, uint k)
        public
        pure
        virtual
        override
